...
import { sendDirectOrderConfirmationEmail } from '../utils/directEmailService';
import { useTranslation } from 'react-i18next';

export const DirectEmailTestPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Send test email directly to Google Apps Script
      const result = await sendDirectOrderConfirmationEmail(
        mockOrderId,
        email,
        name,
        {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-2xl">
      <h1 className="text-3xl font-bold mb-6 text-center">Test direktnega pošiljanja e-pošte</h1>
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          ...
          <p className="text-gray-700">
            Ta stran je namenjena testiranju direktnega pošiljanja e-poštnih sporočil za potrditev naročila. 
          ...
          <p className="text-gray-700 mt-2 text-sm">
            <strong>Opomba:</strong> Ta stran uporablja direktno povezavo z Google Apps Script, 
            brez posredovanja preko Supabase Edge Function.
          </p>
        </div>
      </div>
    </div>
...
export default DirectEmailTestPage;
