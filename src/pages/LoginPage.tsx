    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-md mx-auto bg-white rounded-lg shadow p-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* Mobile-friendly inline error display */}
          {!isLogin && Object.keys(errors).length > 0 && (
            <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded-md">
              <div className="flex items-start">
                <svg className="w-5 h-5 text-red-400 mt-0.5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z" />
                </svg>
                <div className="text-sm">
                  <p className="font-medium text-red-800 mb-1">
                    {t('validation.errorsFound', 'Prosimo, popravite naslednje napake:')}
                  </p>
                  <ul className="text-red-700 space-y-1">
                    ...
                    {errors.processingConsent && (
                      <li>• {errors.processingConsent}</li>
                    )}
                  </ul>
                </div>
              </div>
