...
export const slovenian = {
  ...
  admin: {
    ...
    products: {
      ...
      stockUpdateSuccess: 'Zaloga uspešno posodobljena',
      loading: 'Nalaganje...',
      noProducts: 'Ni izdelkov',
      imageUrl: 'Slika izdelka',
      ...
      save: 'Shrani',
      cancel: 'Prekliči',
      deleteWarning: 'Ali ste prepričani, da želite izbrisati ta izdelek? Te akcije ni mogoče razveljaviti.',
      confirmDeleteButton: 'Izbriši',
      ...
      addNewImage: 'Dodaj novo sliko',
      addImage: 'Dodaj',
      removeImage: 'Odstrani sliko',
      selectFile: 'Izberi datoteko',
      or: 'Ali',
      note: 'Opomba:',
      imageTip1: 'Uporabite poševnice (/) v poteh',
      imageTip2: 'Začnite z /images/ za lokalne slike',
      imageTip3: 'Primer: /images/Poprova meta/Poprova meta1.jpeg',
      imagePathHelp: 'Za lokalne slike uporabite pot kot: /images/imeizdelka/slika.jpg',
