...
serve(async (req) => {
  try {
    ...
    // Hardcoded Google Apps Script URL - latest deployment
    const googleScriptUrl = 'https://script.google.com/macros/s/AKfycbwidvMp1p9pJI91DZfOHJ_YHEy4vMX-E-N5hqM5NvnsHDPbSqtlIvul2CjqY6sbeYW1/exec';
